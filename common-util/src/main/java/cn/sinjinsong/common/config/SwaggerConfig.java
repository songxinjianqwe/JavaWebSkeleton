...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("JavaWeb项目骨架")
                .description("集成了SpringMVC、Spring、MyBaits、JWT、JavaMail、Spring Security、Spring Scheduler、Hibernate Validator、Redis、MyBatis Generator、MyBatis PageHelper、Spring Async、REST风格的接口的Web项目")
